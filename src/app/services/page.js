...
export const metadata = {
  title: "Digital Marketing Services — Numero Uno Marketing Bangalore",
  description: "Performance marketing, social media, web development, AI tools, and more. Fixed pricing for Bangalore MSMEs. No lock-in contracts.",
};
            ...
            {services.map((service) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-[family-name:var(--font-heading)] text-lg font-bold mb-2 text-white">{service.name}</h3>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-white/5 mt-auto">
                    <div className="font-[family-name:var(--font-heading)] text-xl font-extrabold text-green">
                      {service.pricing}
