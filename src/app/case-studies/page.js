...
export const metadata = {
 title: "Case Studies — Real Results for Ambitious Brands | Numero Uno Marketing",
 description: "See how ambitious brands grew revenue, leads, and patients with Numero Uno Marketing. Real case studies with real metrics.",
};
...
export default function CaseStudiesPage() {
 ...
 subtitle="Every metric is real. Every result is verifiable. Here's what happens when ambitious brands partner with Numero Uno."
 center
 />
 </div>
 </section>
 ...
 <div key={i} className="sitewide-card overflow-hidden">
 {/* Header */}
 ...
 <h3 className=" text-lg card-h3 mt-1">{cs.client}</h3>
 </div>
 ...
 {cs.results.map((r, ri) => (
 <div key={ri} className="bg-blue/5 border border-blue/15 rounded-xl p-4 text-center">
 <div className=" text-2xl font-extrabold text-blue">{r.metric}</div>
 ...
 <div>
 <h4 className=" text-sm font-bold text-blue mb-2">Our Strategy</h4>
