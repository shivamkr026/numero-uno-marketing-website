...
export const metadata = {
  title: "Free Marketing Audit — Numero Uno Marketing Bangalore",
    ...
    <>
      <section className="pt-32 pb-10 px-6 lg:px-12 bg-navy">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="font-[family-name:var(--font-heading)] text-[clamp(32px,5vw,52px)] font-extrabold tracking-tight leading-tight mb-4">
            Get Your Free <span className="text-green">Marketing Audit</span>
          </h1>
