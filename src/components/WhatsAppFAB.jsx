...
export default function WhatsAppFAB() {
  return (
    <a
      ...
      className="fixed bottom-7 right-7 z-[500] w-14 h-14 bg-gradient-to-br from-green to-green-dark rounded-full flex items-center justify-center shadow-lg shadow-green/40 hover:scale-110 transition-transform no-underline"
