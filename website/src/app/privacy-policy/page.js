...
export default function PrivacyPolicyPage() {
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Information We Collect</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">How We Use Your Information</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Cookies & Tracking</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Data Sharing</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Data Security</h2>
 <p>We implement appropriate security measures to protect your personal information. However, no method of transmission over the Internet is 100% secure.</p>

 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Your Rights</h2>
 ...
 <p>For questions about this Privacy Policy, contact: <a href="mailto:hello@numerounomarketing.com" className="text-blue no-underline hover:underline">hello@numerounomarketing.com</a></p>
 </div>
 </div>
 </section>
 );
