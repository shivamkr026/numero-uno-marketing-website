...
export default function TermsPage() {
 ...
 <h1 className=" text-3xl section-h2 mb-8">
 Terms of Service
 </h1>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Services</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Payments</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Cancellation</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Intellectual Property</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Limitation of Liability</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Website Use</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Governing Law</h2>
 ...
 <h2 className=" text-lg card-h3 text-white mt-8 mb-3">Contact</h2>
 <p>For questions about these Terms, contact: <a href="mailto:hello@numerounomarketing.com" className="text-blue no-underline hover:underline">hello@numerounomarketing.com</a></p>
 </div>
 </div>
 </section>
 );
